...
\end{align}
  ...
  \end{equation}
	...
	potential and with the separable approximation is not as impressive as for
	the	step potential, it is still very good for cutoffs
	$\Lambda_2\gsim2.5~\fm^{-1}$ ($n>8$).
