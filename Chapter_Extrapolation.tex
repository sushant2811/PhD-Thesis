...
\end{align}
  ...
  In Sec.~\ref{sec:IR_story} we worked in the region where the UV errors were
   ...
   momentum.}
	...
	\ref{fig:deuteron_sep_fit_Epelbaum_evolved} that the fir from
	separable approximation is superior to phenomenological fits.
	Separable approximation allows extrapolation even when we are far from
  ...
  In this section, we will list the open questions with respect to both IR
	...
	We will also briefly touch upon some of these related developments.
  ...
  There has been lot of work on extending the results for IR energy corrections
	...
	extrapolation of the radius-squared operator.  Authors of
	...
	many-body case is same as in the two-body case, just scaled by an
	...
	tails in momentum distributions (or the corresponding short-distance
	...
	Authors of Ref.~\cite{Binder:2015trg} developed interactions from chiral
