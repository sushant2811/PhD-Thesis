...
\chapter{Extrapolation}
  ...
  \end{figure}
	...
	$E=(2n+3/2)\hbar\Omega$, we see that we must identify $N=2n$. Thus,
	$\kappa_{\rm min} = \pi/L_2$ is the lowest momentum in a finite
	oscillator basis with $n \gg 1$ basis states. It is clear from its
	very definition that $\pi/L_2$ is also the infrared cutoff in a finite
	oscillator basis. This clarifies misconceptions found in the recent
	literature~\cite{Stetcu:2006ey,Stetcu:2007ms,Coon:2012ab}.
	...
	\caption{(color online) Deuteron radius squared versus $L_0$ (top) and
