...
\chapter[Factorization]{Factorization
   ...
   \end{overpic}
	...
	\end{figure}
	%
	The virtual photon from electron scattering transfers enough energy and momentum
	to break up the deuteron into a proton and neutron.  The differential cross
	section for deuteron electrodisintegration for unpolarized scattering in the lab
	frame is given by~\cite{Arenhovel:1988qh}
	%
	\begin{multline}
  ...
  \medskip
	...
	This is illustrated in Fig.~\ref{fig:J0_evolution_vs_lambda}, where we
	investigate the effects of the current-operator evolution on $\fL$ as a
	...
	Fig.~\ref{fig:J0_evolution_vs_lambda}.
