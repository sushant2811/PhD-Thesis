...
\label{Appendix:evolution_details}
 ...
 \end{eqnarray}
  ...
  is given by
  \beq
  J_0^{\lambda} = \underbrace{\wt{U} J_0 \wt{U}^\dag}_{J_1} +
  \underbrace{\wt{U} J_0}_{J_2} + \underbrace{J_0 \wt{U}^\dag}_{J_3} + J_0\;.
  \eeq
  ...
  Equation~\eqref{eq:J0_minus_analytical_delta2} is gotten from the
  ...
  Finally, the expression for $J_1$ is
  \begin{multline}
